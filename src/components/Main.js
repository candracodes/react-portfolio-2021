  ...
  return (
        ...
        <div className="container">
            ...
            <div className="row ts-align__vertical">
                <div className="col-md-6">
                    <img src={headshot2} alt="A closeup Black and white photo of Candra Fried, wearing a hat." className="mw-100 mb-5" />
                </div>
                <div className="col-md-6">
                    ...
                    <a href="https://drive.google.com/file/d/1nEIVd1f57W02k71bQhO_hl_hrfHNhduQ/view?usp=sharing"
    ...
    <section className="ts-block pb-5" id="portfolio">
        <div className="container">
            ...
            {/* <!-- START: PORTFOLIO CHOICES --> */}
            <div className="row portfolio-choice-container">
                {/* <!-- choice 1 --> */}
                <div id="portfolio-ux" className="col-sm-12 col-md-3 col-lg-3 portfolio-choice">
                    <a>
                        <img src="./assets/img/portfolio/portfolio-choice-ux.png" className="card-img" alt="Info" />
                    </a>
                </div>
                {/* <!-- choice 2 --> */}
                <div id="portfolio-development" className="col-sm-12 col-md-3 col-lg-3 portfolio-choice">
                    <a>
                        <img src="./assets/img/portfolio/portfolio-choice-dev.png" className="card-img" alt="Info" />
                    </a>
                </div>
                {/* <!-- choice 3 --> */}
                <div id="portfolio-print" className="col-sm-12 col-md-3 col-lg-3 portfolio-choice">
                    <a>
                        <img src="./assets/img/portfolio/portfolio-choice-print.png" className="card-img" alt="Info" />
                    </a>
                </div>
                {/* <!-- choice 4 --> */}
                <div id="portfolio-art" className="col-sm-12 col-md-3 col-lg-3 portfolio-choice">
                    <a>
                        <img src="./assets/img/portfolio/portfolio-choice-art.png" className="card-img" alt="Info" />
                    </a>
                </div>

            </div>
            {/* <!-- END: PORTFOLIO CHOICES --> */}

            {/* <!-- start: UX/UI --> */}
            <div id="show-ux" className="row">
                {/* <!-- ABOUT THIS SECTION --> */}
                <div className="col-sm-12 col-md-12 col-lg-12">
                    <h4 className="portfolio-subheader">UX/UI</h4>
                    <hr className="ts-hr-light" />
                    <p>
                        This section provides a small dose of some examples of recent UX Strategies I've
                        composed.
                        It takes the viewer on a journey of how the project started, defining the initial
                        problems, and what it takes to carve out working solutions. Click on the image below to get a glimpse under the creative hood, and to view other notable projects.
                        
                    </p>
                </div>
                
                <div className="col-sm-12 col-md-12 col-lg-12 ux-large-image">
                    <a className="ux-container" href="./uxui.html">
                        <h4 className="ux-container-text">ReturnLogic UX Strategy</h4>
                        <img src="./assets/img/portfolio/rl-uxui-landing.png" className="card-img" alt="description" />
                    </a>
                    <h5><a className="uxui-link" href="./uxui.html">ReturnLogic | UX Strategy | View Example</a></h5>
            ...
            <div id="show-development" className="row">
                ...
                <div className="ts-gallery col-sm-12 col-md-3">
                    {/* <!-- <a href="./assets/img/portfolio/img-1-daytripper.png" className="card ts-gallery__item popup-image" data-animate="ts-fadeInUp"> --> */}
            ...
            <div id="show-print" className="row">
                ...
                <div className="card-columns ts-gallery ts-column-count-4">
                    ...
                    {/* <!-- GREG'S RANDOM ACTS --> */}
                    <a href="./assets/img/portfolio/img-20-print-big.png"
                        className="card ts-gallery__item popup-image">
                        <div className="ts-gallery__item-description">
